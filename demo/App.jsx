      ...
      <div className="App">
        ...
        <Content fix={this.state.fix}>
          ...
          <div className="item">
            ...
            <p class="desc indent">Kut，一个简单的React-Like的前端视图渲染库，是在学习React源码时造的轮子。目前Kut支持的方法仅有两个，即createElement、render，同时也支持组件化开发，即Component类。已经能满足部分开发需求，这个网页本身就是基于Kut构建的，性能还行。</p>
            <p class="desc indent">由于是参考（抄）的React，所以Kut基本的实现逻辑和React是相似的，Kut进行了改进的一个地方是diff算法。React的diff算法我称其为前向diff，这篇<a href="https://zhuanlan.zhihu.com/p/20346379">文章</a>讲得很好，我就不赘述了。对于把元素从列表中底部挪到顶部的做法，React的前向diff更新操作过多会影响性能，而Kut引入了后向diff，并取前向diff和后向diff的较优结果进行更新，从而提升性能（后面发现有些项目也是这么做的）。大家可以对示例中的待办事项进行添加、打乱来体验。</p>
            <p class="desc indent">由衷感叹一下React实在是太强大了，特别是Fiber。接下来我会慢慢的支持Context、Portal等特性。欢迎大家Pull Request和Star。学习过程中看到的项目有<a href="https://github.com/facebook/react">React</a>、<a href="https://github.com/CodeFalling/react-tiny">React-Tiny</a>、<a href="https://github.com/RubyLouvre/anu">Anu</a>和<a href="https://github.com/215566435/Luy">Luy</a>，而图标是<a href="http://www.iconfont.cn">Iconfont</a>上随手搜索得到的，表示感谢。</p>
          </div>
